  ...
  properties: {
    ...
    siteConfig: {
      ...
      appSettings: [
        ...
        { name: 'CORS_ORIGINS', value: 'https://app-${prefix}-frontend.azurewebsites.net,http://localhost:5173' }
  ...
  properties: {
    ...
    siteConfig: {
      ...
      appSettings: [
        ...
        { name: 'VITE_API_BASE', value: 'https://app-${prefix}-backend.azurewebsites.net' }
        { name: 'VITE_WS_BASE', value: 'wss://app-${prefix}-backend.azurewebsites.net' }
      ]
    }
  }
}
