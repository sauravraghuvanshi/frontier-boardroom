...
| **Contoso AI (us)** | Delhi, India | Full suite: Code Review, PR Triage, On-Call, Test-Gen, Infra-Ops | $25 (starter), $89 (pro), $249 (enterprise) | 5-agent suite, India-data-resident, model-agnostic backbone | No local presence in SEA yet |
...
## Why we win in India
- India-resident inference (Delhi NCR + Mumbai GPU pool) — competitors all proxy through SG.
